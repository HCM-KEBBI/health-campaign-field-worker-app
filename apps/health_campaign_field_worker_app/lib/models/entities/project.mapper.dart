...
class ProjectAdditionalDetailsMapper
  ...
  static String? _$projectTypeId(ProjectAdditionalDetails v) => v.projectTypeId;
  static const Field<ProjectAdditionalDetails, String> _f$projectTypeId =
      Field('projectTypeId', _$projectTypeId, opt: true);
  ...
  static ProjectAdditionalDetails _instantiate(DecodingData data) {
    return ProjectAdditionalDetails(projectTypeId: data.dec(_f$projectTypeId));
  }
...
class _ProjectAdditionalDetailsCopyWithImpl<$R, $Out>
  ...
  late final ClassMapperBase<ProjectAdditionalDetails> $mapper =
      ProjectAdditionalDetailsMapper.ensureInitialized();
  @override
  $R call({Object? projectTypeId = $none}) => $apply(FieldCopyWithData(
      {if (projectTypeId != $none) #projectTypeId: projectTypeId}));
  @override
