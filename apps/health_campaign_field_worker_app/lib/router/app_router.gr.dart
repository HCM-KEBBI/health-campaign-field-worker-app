...
class AcknowledgementRouteArgs {
  ...
  @override
  String toString() {
    return 'AcknowledgementRouteArgs{key: $key, appLocalizations: $appLocalizations, isDataRecordSuccess: $isDataRecordSuccess, isStock: $isStock, label: $label, description: $description, descriptionTableData: $descriptionTableData}';
  }
}
...
class IndividualDetailsRouteArgs {
  ...
  @override
  String toString() {
    return 'IndividualDetailsRouteArgs{key: $key, appLocalizations: $appLocalizations, isEditMode: $isEditMode, isHeadOfHousehold: $isHeadOfHousehold}';
  }
}
