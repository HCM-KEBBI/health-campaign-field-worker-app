...
class TextBlock extends StatelessWidget {
  ...
  List<Widget> _conditionalRender(String? text, TextStyle? style,
    ...
    blocks.addAll(_conditionalRender(
      ...
      captionStyle ??
          theme.textTheme.labelSmall
              ?.copyWith(color: const DigitColors().davyGray),
      addSpacing: caption != null &&
    ...
    blocks.addAll(_conditionalRender(
      ...
      headingStyle ??
          theme.textTheme.displayMedium
              ?.copyWith(color: const DigitColors().woodsmokeBlack),
