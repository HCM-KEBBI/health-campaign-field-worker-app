...
class StatusFilterSMC extends LocalizedStatefulWidget {
  final List<String>? selectedFilters;
  final bool isCloseIcon;
  final Icon? titleIcon;
  final String? titleText;

  const StatusFilterSMC({
    super.key,
  ...
  @override
  State<StatusFilterSMC> createState() => StatusFilterSMCState();
}

class StatusFilterSMCState extends LocalizedState<StatusFilterSMC> {
      ...
      child: Column(
        ...
        children: isLoading
            ...
            : [
                ...
                //           .translate('${value.toValue().toString()}_SMC');
                //     },
                //   ),
                // ),
                const SizedBox(
